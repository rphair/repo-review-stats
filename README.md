...
i.e. _Why is this scripted on top of `gh` rather than constructing API calls using a Javascript-like language + [`octokit`](https://github.com/octokit/octokit.js) to use the GitHub API more canonically?_
