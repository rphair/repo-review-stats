...
This accumulates all repository postings — issues/PRs, comments, reviews, and review comments — then tallies the combined set, sorted oy contributor according to text volume _and_ post count.
