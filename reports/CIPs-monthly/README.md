...
To save space on GitHub — because the huge `reviews.txt` file (27K+ text lines and counting) is mostly the same from month to month (except for the new month + any previous comments that were edited) — this file will live _here in this directory_ and the monthly subdirectories will use it as input data.
